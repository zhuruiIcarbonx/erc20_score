...
func (_Contract *ContractTransactor) Burn(opts *bind.TransactOpts, account common.Address, value *big.Int) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "burn", account, value)
}

// Burn is a paid mutator transaction binding the contract method 0x9dc29fac.
//
// Solidity: function burn(address account, uint256 value) returns()
func (_Contract *ContractSession) Burn(account common.Address, value *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.Burn(&_Contract.TransactOpts, account, value)
}

// Burn is a paid mutator transaction binding the contract method 0x9dc29fac.
//
// Solidity: function burn(address account, uint256 value) returns()
func (_Contract *ContractTransactorSession) Burn(account common.Address, value *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.Burn(&_Contract.TransactOpts, account, value)
}
...
func (_Contract *ContractFilterer) FilterBurn(opts *bind.FilterOpts, from []common.Address) (*ContractBurnIterator, error) {
	...
	logs, sub, err := _Contract.contract.FilterLogs(opts, "Burn", fromRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Burn(address indexed from, uint256 value)
func (_Contract *ContractFilterer) WatchBurn(opts *bind.WatchOpts, sink chan<- *ContractBurn, from []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Contract.contract.WatchLogs(opts, "Burn", fromRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
func (_Contract *ContractFilterer) FilterMint(opts *bind.FilterOpts, to []common.Address) (*ContractMintIterator, error) {
	...
	logs, sub, err := _Contract.contract.FilterLogs(opts, "Mint", toRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Mint(address indexed to, uint256 value)
func (_Contract *ContractFilterer) WatchMint(opts *bind.WatchOpts, sink chan<- *ContractMint, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Contract.contract.WatchLogs(opts, "Mint", toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
